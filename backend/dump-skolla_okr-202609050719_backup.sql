...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '44829be1-bea2-11ec-aae7-00163e018088:1-334909';
...
CREATE TABLE `AnnualKeyResult` (
  ...
  PRIMARY KEY (`id`),
  KEY `AnnualKeyResult_objectiveId_fkey` (`objectiveId`),
...
CREATE TABLE `CausalLink` (
  ...
  `createdAt` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
  KEY `CausalLink_sourceKrId_idx` (`sourceKrId`),
  KEY `CausalLink_targetKrId_idx` (`targetKrId`),
...
CREATE TABLE `Initiative` (
  ...
  `assignedLeaderId` varchar(191) DEFAULT NULL,
  ...
  `sprintMonth` varchar(191) DEFAULT NULL,
  `createdAt` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updatedAt` datetime(3) NOT NULL,
  `documentationLink` varchar(191) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Initiative_sprintMonth_idx` (`sprintMonth`),
  KEY `Initiative_keyResultId_idx` (`keyResultId`),
  KEY `Initiative_teamId_idx` (`teamId`),
  KEY `Initiative_ownerId_idx` (`ownerId`),
...
CREATE TABLE `InitiativeUpdate` (
  ...
  `note` text,
  `kanbanStatus` varchar(191) DEFAULT NULL,
...
CREATE TABLE `KeyResult` (
  ...
  `createdAt` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updatedAt` datetime(3) NOT NULL,
  `annualKeyResultId` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `month` varchar(191) DEFAULT NULL,
  `monthWeight` double NOT NULL DEFAULT '1',
  `isManualOverride` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `KeyResult_objectiveId_idx` (`objectiveId`),
  KEY `KeyResult_annualKeyResultId_fkey` (`annualKeyResultId`),
...
CREATE TABLE `Task` (
  ...
  `currentValue` double NOT NULL DEFAULT '0',
  `unit` varchar(191) DEFAULT NULL,
  `assignedTeamMemberId` varchar(191) DEFAULT NULL,
  `assignedBy` varchar(191) DEFAULT NULL,
  `sprintMonth` varchar(191) DEFAULT NULL,
  `startDate` datetime(3) DEFAULT NULL,
  `finishDate` datetime(3) DEFAULT NULL,
  ...
  `documentationLink` varchar(191) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Kpi_initiativeId_idx` (`initiativeId`),
  KEY `Task_assignedTeamMemberId_idx` (`assignedTeamMemberId`),
  KEY `Task_sprintMonth_idx` (`sprintMonth`),
  CONSTRAINT `Kpi_initiativeId_fkey` FOREIGN KEY (`initiativeId`) REFERENCES `Initiative` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TaskAssignment` (
  ...
  KEY `KpiAssignment_userId_idx` (`userId`),
  CONSTRAINT `KpiAssignment_kpiId_fkey` FOREIGN KEY (`taskId`) REFERENCES `Task` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `KpiAssignment_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TaskUpdate` (
  ...
  CONSTRAINT `KpiUpdate_kpiId_fkey` FOREIGN KEY (`taskId`) REFERENCES `Task` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Team` (
  ...
  `name` varchar(191) NOT NULL,
  `managerId` varchar(191) DEFAULT NULL,
  `leaderId` varchar(191) DEFAULT NULL,
  `department` varchar(191) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Team_leaderId_idx` (`leaderId`),
