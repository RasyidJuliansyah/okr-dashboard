...
router.put('/causal-links/:id', auth_middleware_1.authMiddleware, causal_controller_1.updateCausalLink);
router.delete('/causal-links/:id', auth_middleware_1.authMiddleware, causal_controller_1.deleteCausalLink);
