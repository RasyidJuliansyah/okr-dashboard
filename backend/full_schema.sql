-- ============================================================
-- FULL SCHEMA -- OKR Dashboard (generated from schema.prisma)
-- ============================================================
-- PERINGATAN: File ini berisi CREATE TABLE untuk SEMUA tabel dari
-- keadaan kosong (fresh database). JANGAN dijalankan langsung ke
-- database yang SUDAH ADA DATANYA -- akan gagal (tabel sudah ada)
-- atau kalau di-DROP dulu, SEMUA DATA AKAN HILANG.
--
-- Gunakan file ini hanya untuk:
--   - Setup database baru / kosong (dev, staging, testing)
--   - Dokumentasi / referensi struktur skema saat ini
--
-- Untuk database production yang sudah ada datanya, gunakan
-- add_documentation_links.sql (hanya menambah kolom baru, aman).
-- ============================================================
